...
function onFormSubmit(event) {
    ...
    Api.executeGetMethod('users', data)
...
const LoginPage = () => {
    ...
    return (
        <div class="rendered-form">
            <form action="#" method="GET" id="loginForm" onSubmit={onFormSubmit}>
                <div class="">
                ...
                <div class="formbuilder-button form-group field-button-1699215453339">
                    <button type="submit" class="btn-success btn" value="Login">Login</button>
                </div>
            </form>
        </div>
    );
